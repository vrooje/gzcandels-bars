...
{\changed median volunteer bar vote percentage and interquartile range are $0.1_{-0.1}^{+0.08}$.} 
 The science team and volunteer bar vote percentages {\changed correlate ($r = 0.8${\changedtwo\ with high significance: 
...
%The actual p-value is 8.2e-179 but printing that just seems like a big up-yours to the referee. Null hypothesis RULED OUT, biyotch.
