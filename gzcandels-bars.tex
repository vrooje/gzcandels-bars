...
In order to account for this possible contamination, we add an appropriate fraction of featureless, not-edge-on galaxies to each redshift bin of the {\changed \disklz\ sample}. The bar fractions derived below are thus conservative lower limits.
