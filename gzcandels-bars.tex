...
$^{3}$SEPnet,\thanks{www.sepnet.ac.uk} South East Physics Network, School of Physics \& Astronomy, University of Southampton, Highfield, Southampton SO17 1BJ, UK\\
...
$^{6}$Department of Astronomy and Astrophysics, 1156 High Street, University of California, Santa Cruz, CA 95064, USA\\
$^{7}$Institute for Astronomy, ETH Z\"urich, Wolfgang-Pauli-Strasse 27, CH-8093 Z\"urich, Switzerland\\
...
Among the galaxies in the highest-redshift bin of the sample, 2 of the 8 barred galaxies appear to be undergoing an interaction or merger, and another 2 appear tidally disturbed, possibly by a nearby companion. This may suggest these bar features are merger induced. However, when comparing the distribution of Galaxy Zoo vote fractions for the question ``Is the galaxy currently merging or is there any sign of tidal debris?'', there are no statistically significant differences (according to K-S tests) between the barred and unbarred samples in any redshift bin for vote fractions for tidal features, merger features, or both. {\notebsm (The K-S test also doesn't statistically confirm that the samples are the SAME, though. It's just inconclusive.)}
