...
{\changed median volunteer bar vote percentage and interquartile range are $0.1_{-0.1}^{+0.08}$.} 
 The science team and volunteer bar vote percentages {\changed correlate ($r = 0.8${\changedtwo\ with very high significance\footnote{\changedtwo The statistics package {\tt R} reported $p< 2.2 \times 10^{-16}$, i.e., a value smaller than can be precisely reported using floating-point precision.}: 
